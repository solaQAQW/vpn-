...
完成之后，就可以正常访问官网和使用客户端了。另外，**官方针对中国用户发布了中文版的使用教程，<a rel="nofollow noopener" href="https://linkv.org/strongcn/" target="_blank">进入Strong官网</a>，点击右上角Help，查找 “在中国境内如何下载，安装以及使用StrongVPN”**。
