...
[![翻墙，VPN推荐](/image/wall-min.png "翻墙")](#翻墙软件vpn推荐指南含2020优惠)
...
### 每年3月上旬开会期间
这是上面开会的时候，外网基本上很难上去，两会期间更甚，一线的翻墙VPN和绝大多数商业科学上网软件会大部分失效，可连的节点变得少之又少，有些VPN能切换到IPsec协议之后使用，但速度也不能保证，还有些VPN软件使用备用的OpenVPN手动设置也能用。少数比较隐蔽的私人自架服务器可能还能勉强能连，但一般也慢得可怜，断线断得你锤头丧气。这时候还是建议少上网，多看央视直播，关心国家大事，似懂非懂地和你的男同事们坐而论道撸串比较好。
...
>适合注重隐私数据保护和较好的使用体验的朋友。如果要求性价比，[StrongVPN](#2-strongvpn)、[NordVPN](#3-nordvpn)或者[PandaVPN](#4-pandavpn)应该会更适合你，[StrongVPN](#2-strongvpn)可以作为ExpresssVPN替代方案，稳定性也不错，可连节点比Expresss多，但速度比ExpresssVPN慢一些，看YouTube和开网页没问题；[NordVPN](#3-nordvpn)要优先连接日本、新加坡、英国、加拿大这些地区新出的服务器节点，速度很快，但敏感时期的稳定性不如前2位；[PandaVPN](#4-pandavpn)我感觉类似于SSR，速度还不错，官网称有256位加密保护，不过隐私条款比较模糊，我感觉对于隐私安全的保护不如ExpressVPN、StrongVPN和NordVPN。
...
虽说名字是VPN，但我感觉这家的底层技术更类似于SSR，因为连接建立连接的速度不错，而且客户端里能区分全局代理或分应用代理，官网称有256位加密保护，不过我感觉对于隐私安全的保护可能不如[ExpressVPN](#1-expressvpn)、[StrongVPN](#2-strongvpn)和Nord，暂且把它作为VPN看待。
