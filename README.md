...
>2020年11月使用，确认可用，可用节点较多，有些节点网络速度不错，有些节点网络速度就一般，要自己测试。性价比最好，有优惠码可使用。Windows、Mac和Android设备用户建议找客服要中国地区专用客户端，使用OpenVPN（TCP）协议连接成功率一直很高（敏感时期也很稳），官方标准客户端版本在敏感时期有时会遇到连接问题，需等几日版本更新才能恢复正常。
...
**另外，和Windows系统一样，Mac和安卓用户也可以找客服获取中国专用版本客户端，在敏感时期连接成功率很高，官网的标准版客户端遇到墙升级可能会存在连接问题，要等几日版本更新才能恢复正常使用**。
