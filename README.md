...
>适合注重隐私数据保护和较好的使用体验的朋友。如果要求性价比，[NordVPN](#2-nordvpn)或者[PandaVPN](#3-pandavpn)应该会更适合你，[NordVPN](#2-nordvpn)要优先连接日本、新加坡、英国、加拿大这些地区新出的服务器节点，速度很快，但敏感时期的稳定性不如ExpressVPN；[PandaVPN](#3-pandavpn)我感觉类似于SSR，速度还不错，官网称有256位加密保护，不过隐私条款比较模糊，我感觉对于隐私安全的保护不如Express和Nord。
...
虽说名字是VPN，但我感觉这家的底层技术更类似于SSR，因为连接建立连接的速度不错，而且客户端里能区分全局代理或分应用代理，官网称有256位加密保护，不过我感觉对于隐私安全的保护可能不如[Express](#1-expressvpn)和Nord，暂且把它作为VPN看待。

最开始使用体验不错，但近一个月的**稳定性**体验下降了，估计是用的人多了，这方面比[ExpressVPN](#1-expressvpn)差一些，不过勉强也能接受。
...
>2020年3月测试，确认可用，但没有亮点，体验中规中矩，有些节点能连上，但网速不算快。Mac用户不推荐使用这款。
...
[![IVacy](/image/ivacy-logo.png)](#5-ivacy)

>2020年3月测试，确认可用，长期套餐价格最低，但速度较慢，客服说正在改进服务器，看后续表现再更新。
